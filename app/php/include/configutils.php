...
if (! function_exists('config_defaults')) {
	function config_defaults($config = array()) {
		...
		$config['export_audio_frequency'] = (empty($config['export_audio_frequency']) ? '44100' : $config['export_audio_frequency']);
		$config['export_audio_switches'] = (empty($config['export_audio_switches']) ? '' : $config['export_audio_switches']);
		...
		$config['export_fps'] = (empty($config['export_fps']) ? '30' : $config['export_fps']);
		$config['export_input_switches'] = (empty($config['export_input_switches']) ? '' : $config['export_input_switches']);
		$config['export_meta_title'] = (empty($config['export_meta_title']) ? '' : $config['export_meta_title']);
		$config['export_switches'] = (empty($config['export_switches']) ? '' : $config['export_switches']);
		$config['export_video_bitratre'] = (empty($config['export_video_bitratre']) ? '2000' : $config['export_video_bitratre']);
		...
		$config['import_audio_frequency'] = (empty($config['import_audio_frequency']) ? '44100' : $config['import_audio_frequency']);
		...
		$config['import_fps'] = (empty($config['import_fps']) ? '10' : $config['import_fps']);
